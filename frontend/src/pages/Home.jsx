    ...
    <div className="fade-in">
      ...
      <section className="section">
        ...
        <div className="shortcut-grid">
          ...
          <Link to="/gratidao" className="shortcut sc-grat">
            <span className="sc-ic">🌻</span>
            <span className="sc-title">Gratidão</span>
            <span className="sc-desc">Registre as bênçãos do dia</span>
            {stats.gratitudeCount > 0 && <span className="sc-badge">{stats.gratitudeCount} registros</span>}
          </Link>
        </div>
      </section>

      {/* Ecossistema Viva Inteligente */}
      <section className="section">
        ...
        <div className="shortcut-grid">
          ...
          <Link to="/estudos" className="shortcut sc-studies">
            <span className="sc-ic">🎓</span>
            <span className="sc-title">Estudos</span>
            <span className="sc-desc">Jornada de crescimento espiritual</span>
          </Link>
          <Link to="/comunidade" className="shortcut sc-community">
            <span className="sc-ic">🤝</span>
            <span className="sc-title">Comunidade</span>
            <span className="sc-desc">Cresça em comunhão</span>
          </Link>
        </div>
      </section>
